        ...
        <Layout>
            <div className="project-parent parent">
                ...
                <div className="project-box" data-aos="fade-up" data-aos-easing='ease-in-out'>
                    ...
                    <p>A personal Flask-based portfolio. This portfolio showcases my skills, projects, and experience as a Full-Stack Web Developer Hosted on Render.</p>
                    <ul className="tech-stack flex flex-wrap gap-3 mt-[10px]">
                        <li>HTML</li>
                        <li>CSS</li>
                        <li>JavaScript</li>
                ...
                <div className="project-box" data-aos="fade-up" data-aos-easing='ease-in-out'>
                    ...
                    <div className="screenshot-img h-[200px] bg-[#801B36]">
                    <img src={portfoliov2} alt="beulah" className="w-full h-full"/>
                    </div>

                    <h3 className="text-[30px] font-semibold py-[15px]">My.Portfolio V2</h3>
                    <p>A sleek, interactive portfolio version 2 built with React and Tailwind for a smooth user experience. Hosted on Render.</p>
                    <ul className="tech-stack flex flex-wrap gap-3 mt-[10px]">
                        <li>React</li>
                        <li>Tailwind</li>
                    </ul>
